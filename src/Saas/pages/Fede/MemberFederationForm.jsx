...
function MemberFederationForm({ open, handleClose, getMembers }) {
  ...
  const { StoreFederationUser, activeId, activeType } = UseAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const res = await StoreFederationUser(formData);
      console.log(res);
      if (res.success) {
        setFormData({
          fullname: "",
...
export default MemberFederationForm;
